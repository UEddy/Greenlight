...
# Canonical nationality list, scoped to the 12 passports named in the spec.
# Each entry records the exact label used by each source, because the sources
# disagree on casing and we refuse to guess a match by transforming strings.
# If a label stops matching, the build fails loudly rather than dropping a row.
NATIONALITIES = [
    {"name": "Nigeria",     "iso3": "NGA", "uk_label": "Nigeria",     "us_label": "NIGERIA"},
    {"name": "Ghana",       "iso3": "GHA", "uk_label": "Ghana",       "us_label": "GHANA"},
    {"name": "Kenya",       "iso3": "KEN", "uk_label": "Kenya",       "us_label": "KENYA"},
    {"name": "India",       "iso3": "IND", "uk_label": "India",       "us_label": "INDIA"},
    {"name": "Pakistan",    "iso3": "PAK", "uk_label": "Pakistan",    "us_label": "PAKISTAN"},
    {"name": "Bangladesh",  "iso3": "BGD", "uk_label": "Bangladesh",  "us_label": "BANGLADESH"},
    {"name": "Vietnam",     "iso3": "VNM", "uk_label": "Vietnam",     "us_label": "VIETNAM"},
    {"name": "Philippines", "iso3": "PHL", "uk_label": "Philippines", "us_label": "PHILIPPINES"},
    {"name": "Egypt",       "iso3": "EGY", "uk_label": "Egypt",       "us_label": "EGYPT"},
    {"name": "Morocco",     "iso3": "MAR", "uk_label": "Morocco",     "us_label": "MOROCCO"},
    {"name": "Indonesia",   "iso3": "IDN", "uk_label": "Indonesia",   "us_label": "INDONESIA"},
    {"name": "Nepal",       "iso3": "NPL", "uk_label": "Nepal",       "us_label": "NEPAL"},
]
...
# Verified but not yet built, scheduled for the next session.
# EU Commission Schengen visa statistics, consulates, 2025.
...
#   format: xlsx. axis: application_location, there is no applicant
#   nationality field anywhere in the workbook. The measure is uniform visas
#   not issued, which includes withdrawn and inadmissible cases and therefore
#   runs above a true refusal rate.
